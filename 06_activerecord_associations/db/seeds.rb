...
4.times do 
  walk = Walk.create(time: rand(1..24).hours.ago)
  num_dogs_on_walk = rand(1..4)
  walk.dog_ids = Dog.ids.sample(num_dogs_on_walk)
end

Dog.all.each do |dog|
  num_feedings = rand(0..3)
  num_feedings.times do 
    dog.feedings.create(time: rand(1..24).hours.ago)
  end
end